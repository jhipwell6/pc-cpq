	...
	<?php 
		...
		foreach ( $Lead->get_Parts() as $Part ) :
			if ( is_array( $Part->get_Pricing_Model() ) && ! empty( $Part->get_Pricing_Model() ) ) :
				$show_metal_factor = $Lead->include_metal_factor();
						...
						<td class="pc-cpq-col--details">
							<table class="parts-table__nested">
								<tbody>
									...
									<tr class="parts-table__nested-head">
										<th class="pc-cpq-col--qty">Quantities (<?php echo esc_html( $Part->get_Pricing()->get_quantity_unit_label() ); ?>)</th>
										<th class="pc-cpq-col--price">$ / <?php echo esc_html( $Part->get_Pricing()->get_price_unit_label() ); ?></th>
									</tr>
									<tr>
